document.addEventListener("DOMContentLoaded",()=>{const rawMap = L.map('rawMap').setView([12.24755, 76.715283], 15);
L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png').addTo(rawMap);

const predictionMap = L.map('predictionMap').setView([12.24755, 76.715283], 15);
